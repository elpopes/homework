...
class MetaCorgiSnacks
  ...
  # Using a method_missing instance method, re-factor CorgiSnacks into the new MetaCorgiSnacks 
#   Within method_missing use #send to call methods on your @snack_box. You can interpolate to get the method name, and then pass the method name to #send
