...
# Before you start
# Bugs happen. Don't be afraid of trying something because you are scared it might not work. Part of being a programmer is giving your crazy ideas a shot to see if they work. That is why you have Git at your disposal; remember to use Git as a safety net that WILL save you if you ever mess up really badly.

# Google is your friend
# When it comes to Rails, chances are that someone has already asked the exact same question that you have. StackOverflow will generally have a question related to yours on it. Be sure to get into the habit of googling when something goes wrong or you don't know something. Your TA is always happy to help, but when you leave App Academy, your TA won't be there for you. Part of being a good developer is knowing how to find the answers yourself.
...
# Better errors is going to open whenever your code throws an exception of some sort. What happens if your code isn't throwing an error, but doesn't work the way that you want it to?

# Luckily, your controllers have a method called fail. By typing fail in a controller, it basically pauses your code at that point and will open up Better Errors. For example,
...
# With this fail, your code will stop just after @post = Post.new(params[:id]). You can now do things like p @post and try to save it manually to see what's going wrong with your code.
...
# Check that objects being built via associations are built correctly. E.g., current_user.posts.new(post_params).
# For further debugging tips, take a look at the Rails Docs.