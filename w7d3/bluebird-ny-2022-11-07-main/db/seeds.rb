...
ApplicationRecord.transaction do
  ...
  # Instructors
  puts "Creating Users..."
  elliot = User.create!(username: "all_knowing_elliot", password: "password", age: 11, political_affiliation: "C", email: "those_are_teef@aa.io")
  ryan = User.create!(username: "will_climb_rocks", password: "password", age: 11, political_affiliation: "JavaScript" , email: "boulderz@aa.io")
  dean = User.create!(username: "dean_machine", password: "password", age: 11, political_affiliation: "Ruby", email: "deans_diary@aa.io")
  angela = User.create!(username: "loves_capy", password: "password", age: 11, political_affiliation: "JavaScript", email: "chosenone@aa.io")
  charlos = User.create!(username: "charlos_gets_buckets", password: "password", age: 11, political_affiliation: "Ruby", email: "ballin@aa.io")
  alissa = User.create!(username: "cow_luva", password: "password", age: 11, political_affiliation: "JavaScript" , email: "cows@aa.io")
  joe = User.create!(username: "trader_joes_4lyf3", password: "password", age: 11, political_affiliation: "Ruby", email: "thetraderjoe@aa.io")
  walker = User.create!(username: "wakka_wakka", password: "password", age: 11, political_affiliation: "JavaScript", email: "wakka@wakka.walking")
  mike = User.create!(username: "like_mike", password: "password", age: 11, political_affiliation: "Ruby", email: "mike@aa.io")
  michelle = User.create!(username: "michelle_bell", password: "password", age: 11, political_affiliation: "JavaScript", email: "michelle@aa.io")
  vanessa = User.create!(username: "the_vanessa", password: "password", age: 11, political_affiliation: "Ruby", email: "vanessa@aa.io")
  jen = User.create!(username: "jen_ken_intensifies", password: "password", age: 11, political_affiliation: "JavaScript", email: "jen@aa.io")
  big_company = User.create!(username: "instructors_rock", password: "password", age: 52, political_affiliation: "Instructors", email: "giveus@money.now")
