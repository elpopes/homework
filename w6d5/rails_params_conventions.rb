...
# Fundamentally, HTML forms don't know about any sort of structured data: all they generate is name–value pairs, where pairs are just plain strings. The arrays and hash-like objects you see in your application are the result of some parameter naming conventions that Rails uses.
